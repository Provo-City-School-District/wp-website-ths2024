                                ...
                                <a href="<?php the_permalink(); ?>">
                                    <div class="featured-image">
                                        ...
                                        <?php
                                            ...
                                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/building-image.jpg'; ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="Building Image" width="217" height="175">
                                        <?php } ?>
                                    </div>
                                </a>
